...
def main(bot,update):
  ...
  if a == "light on" or a=="switch on the light" or a== "lights" or a== "turn on light":
   lighton(bot,update) 
  elif a == "fan on" or a=="switch on the fan" or a== "feeling hot":
   fanon(bot,update) 
  elif a == "light off" or a == "gotta sleep" or a=="lights out" or a== "turn off light" :
    lightoff(bot,update)
  elif a == "fan off" or a == "switch off the fan" or a=="feeling cold" :
    fanoff(bot,update)
  else:
     bot.message.reply_text('INVALID INPUT!!!')   


BOT_TOKEN = '1902423593:AAFjtNyXe-ekLDFmJYGJDL9JiTuq2Ct2hjo'
